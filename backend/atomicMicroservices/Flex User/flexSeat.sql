...
CREATE TABLE IF NOT EXISTS `flexSeat` (
    ...
    PRIMARY KEY (userId, startDestination, endDestination, startDateTime, endDateTime)
...
INSERT INTO `flexSeat` (`userId`, `startDestination`, `endDestination`, `startDateTime`, `endDateTime`, `createdAt`) 
VALUES 
...
(6, 'New York', 'London', '2025-04-01 07:30:00', '2025-04-30 15:00:00', NOW()),
(7, 'New York', 'London', '2025-04-01 07:30:00', '2025-04-30 15:00:00', NOW()),
(8, 'New York', 'London', '2025-04-01 07:30:00', '2025-04-30 15:00:00', NOW());
